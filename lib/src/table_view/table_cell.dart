...
class TableViewCell extends StatelessWidget {
  ...
  const TableViewCell({
    ...
    required this.child,
          ...
          (rowMergeStart == null && rowMergeSpan == null) || (rowMergeStart != null && rowMergeSpan != null),
        ...
        assert(
          (columnMergeStart == null && columnMergeSpan == null) || (columnMergeStart != null && columnMergeSpan != null),
...
class _TableViewCell extends ParentDataWidget<TableViewParentData> {
  ...
  void applyParentData(RenderObject renderObject) {
    final TableViewParentData parentData = renderObject.parentData! as TableViewParentData;
